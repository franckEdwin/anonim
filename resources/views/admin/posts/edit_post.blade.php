            ...
            <form method="post" action="{{ route('update_edit_post', $post->id) }}">
                ...
                <div class="card-body">
                    ...
                    <div class="form-group mb-3 row">
                        ...
                        <div class="col">
                            <a href="{{ url('storage/app/public/'.$post->image) }}" target="_blank"><span class="avatar avatar-xl" style="background-image: url({{ url('storage/app/public/'.$post->image) }})"></span></a>
                        </div>
                    </div>
