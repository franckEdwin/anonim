    ...
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            ...
            @if (!Auth::check())
                ...
                @elseif(Auth::check() && (empty(Auth::user()->genders_id) || empty(Auth::user()->birth)))
    <!-- Utilisateur connecté mais genre ou date de naissance non définis -->
    <!-- Vous pouvez ajouter le formulaire de création de post ici -->
