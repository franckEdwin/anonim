<div class="col-lg-3">
  ...
  <!-- Affichage de l'image -->
   @if ($item->image)
   <img src="{{ url('storage/app/public/'.$item->image) }}" alt="Image" style="height:auto; width:auto; ">
  @endif 

  <!-- <a class="card-link" href="{{ url('item/'.$item->slug) }}">
          <div class="card-cover" style="background-image: url({{ url('storage/app/public/'.$item->image) }}); min-height:250px; width:100%;">
