                ...
                <div class="card-body">
                    ...
                    <div class="form-group mb-3 row">
                        ...
                        <div class="col">
                            ...
                            <!-- Sélection des avatars par défaut -->
                            <div class="mb-2">
                                {{-- <label class="form-label">{{ __('main.default_avatars') }}</label> --}}
                                <div class="d-flex">
                                    @foreach($defaultAvatars as $defaultAvatar)
                                        <label class="avatar avatar-md avatar-default">
                                            <input type="radio" name="default_avatar" value="{{ $defaultAvatar }}" {{ $user->avatar == $defaultAvatar ? 'checked' : '' }}>
                                            <img src="{{ url('storage/app/public/images/avatar/' . $defaultAvatar) }}" alt="Default Avatar">
                                        </label>
                                    @endforeach
                                </div>
                            </div>
                    
                            <!-- Téléchargement de l'avatar personnalisé -->
                            {{-- <label class="form-label">{{ __('main.upload_custom_avatar') }}</label> --}}
                            {{-- <input type="file" name="avatar" class="form-control @error('avatar') is-invalid @enderror"> --}}
