...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body class="font-sans antialiased">
        ...
        <script src="{{ asset('resources/views/assets2/dist/libs/jquery/dist/jquery.min.js') }}"></script>
        <script src="{{ asset('resources/views/assets2/dist/libs/simplebar/dist/simplebar.min.js') }}"></script>
        <script src="{{ asset('resources/views/assets2/dist/libs/bootstrap/dist/js/bootstrap.bundle.min.js') }}"></script>
       
        <script src="{{ asset('resources/views/assets2/dist/js/app.min.js') }}"></script>
        <script src="{{ asset('resources/views/assets2/dist/js/app.horizontal.init.js') }}"></script>
        <script src="{{ asset('resources/views/assets2/dist/js/app-style-switcher.js') }}"></script>
        <script src="{{ asset('resources/views/assets2/dist/js/sidebarmenu.js') }}"></script>
        
        <script src="{{ asset('resources/views/assets2/dist/js/custom.js') }}"></script>
       
        <script src="{{ asset('resources/views/assets2/dist/libs/owl.carousel/dist/owl.carousel.min.js') }}"></script>
        <script src="{{ asset('resources/views/assets2/dist/libs/apexcharts/dist/apexcharts.min.js') }}"></script>
        <script src="{{ asset('resources/views/assets2/dist/js/dashboard.js') }}"></script>
